...
export const metadata: Metadata = {
  title: "AI Chatbot Packages | FoundLabs",
  description:
    "Explore FoundLabs' AI chatbot service packages — from Starter bots to Smart RAG chatbots and AI Support Assistants. Powered by GPT-4o, built for business.",
  keywords: [
    "AI chatbot packages",
    "GPT-4o chatbot pricing",
    "smart RAG chatbot service",
    "custom AI assistant",
    "FoundLabs AI pricing",
  ...
  openGraph: {
    title: "AI Chatbot Packages | FoundLabs",
    description:
      "Choose the perfect AI chatbot package for your business. FoundLabs offers GPT-4o powered bots, trained on your content, ready to scale your support.",
    url: "https://foundlabs.online/packages",
    siteName: "FoundLabs",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "FoundLabs AI Chatbot Services",
      },
    ],
    type: "website",
  },
  twitter: {
    ...
    title: "AI Chatbot Packages | FoundLabs",
    description:
      "Explore GPT-4o chatbot solutions — from simple FAQ bots to fully integrated AI support agents. Built for solopreneurs, SaaS, and enterprises.",
...
const PackagesPage = () => {
  const jsonLd = {
    ...
    "@type": "Product",
    name: "FoundLabs AI Chatbot Packages",
    brand: {
      "@type": "Organization",
      name: "FoundLabs",
    },
    description:
      "Choose from FoundLabs AI chatbot packages to automate support, sales, and engagement using GPT-4o and RAG technology.",
    url: "https://foundlabs.online/packages",
  };
  return (
    <>
      <Head>
        <title>AI Chatbot Packages – FoundLabs</title>
        <meta
          name="description"
          content="Affordable GPT-4 AI chatbot packages for businesses. Embed AI agents, automate customer support, and grow faster."
        />
        <script
              ...
              <div className="bg-gray-900 rounded-xl border-2 border-[#724BF0] overflow-hidden transform scale-105 z-10 ">
                <div className="p-6 h-full flex flex-col">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-gray-400 mt-3 text-sm">
                      Your chatbot becomes a smart assistant trained on your
                      PDFs, site content, or internal docs. Ideal for reducing
                      support tickets and boosting engagement.
                    </p>
                  </div>
