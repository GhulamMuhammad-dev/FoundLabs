...
const AboutPageClient = () => {
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        "FoundLabs is an AI solution company focused on automating business operations using intelligent chatbots, RAG systems, and workflow tools.",
      foundingDate: "2022",
      founders: [
        {
          "@type": "Person",
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-5 text-gray-300 text-lg leading-relaxed">
                <p>
                  Founded in 2022 by a team of AI engineers and startup veterans, FoundLabs emerged from our frustration with seeing
                  brilliant founders bogged down by operational tasks instead of focusing on growth.
                </p>
                <p>
                  We started with a simple chatbot for a local e-commerce store. Today, we’ve grown into a full-service AI automation partner
        ...
        <div className="py-20 px-4 sm:px-6 lg:px-8 bg-[#1c1c1e]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-[#2a2a2d] rounded-xl p-8 text-center border border-[#333]"
              >
                <div className="flex justify-center mb-4">
                  <div className="p-4 bg-[#724bf0]/10 rounded-full">{value.icon}</div>
                </div>
